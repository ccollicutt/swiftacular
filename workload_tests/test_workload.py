...
def run_workload_test(mean_size, max_size, min_size, stdev_size, retention_time,
                     upload_interval, total_uploads, batch_size, connection):
   ...
   some_container = connection.create_container(random_name)
   uploaded_objects = workloader.create_workload(some_container)
   verifier = Verifier()
